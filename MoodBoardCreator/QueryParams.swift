...
//let black = Color(color: UIColor(red: 0/255, green: 0/255, blue: 0/255, alpha: 0.8) ,title: "Blac", queryTerm: "black")
...
class Colors {
    static var colors = [blue,yellow,teal,red,green,magenta]
}
