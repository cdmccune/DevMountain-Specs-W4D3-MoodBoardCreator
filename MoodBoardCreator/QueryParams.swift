...
var blackAndWhite = Color(color: UIColor(red: 0/255, green: 0/255, blue: 0/255, alpha: 0.8) ,title: "Black And White", queryTerm: "black_and_white")
var white = Color(color: .systemBackground ,title: "White", queryTerm: "white")
var any = Color(color: UIColor(red: 0/255, green: 0/255, blue: 0/255, alpha: 0.8) ,title: "Any", queryTerm: "any")
...
class Colors {
    static var colors = [any,blackAndWhite,white,black,blue,yellow,teal,red,green,magenta]
}
